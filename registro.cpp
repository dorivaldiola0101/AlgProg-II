// Exemplo base para resolver os exercícios de Struct!!
...
fornecida pelo usuario*/void listagem2(int n, tPessoa vetor[], tData D)
{    for(int i = 0; i < n; i++){
        if(
...
int main(){
    ...
    do{        
        ...
        {            // listar todos os nomes e alturas
            ...
            // listas todos os nomes das pessoas que nasceram antes de uma            // data D informada pelo usuario
